...
describe("Coach Demo", () => {
  ...
  it("test1", () => {
    ...
    cy.get("button").contains("x").realHover().wait(1500);
    cy.get("button").contains("x").click().wait(1000);
    cy.get(".PinBoard_pinBoard__3Ba5f>div:nth-child(6)").contains("x").click().wait(1000);
    cy.get(".PinBoard_pinBoard__3Ba5f>div:nth-child(5)")
    ...
    cy.get(`a[href="https://main.d3rc3gpot85iux.amplifyapp.com/student/122"]`).scrollIntoView({duration: 1000}).wait(1500).click();
    cy.get("button").contains("Log In").click()
    cy.get(`a[href="https://main.d3rc3gpot85iux.amplifyapp.com/student/122"]`).contains("Cassandra").click()
    // cy.get(`button[class="LogoutButton_logout__3XION"]`).click();
  });
});
